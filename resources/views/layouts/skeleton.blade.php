...
!function (e) {
  if (!e.navigate) {
    ...
    e.addEventListener("load", a, !1), e.addEventListener("message", (t => {
      if (console.log(t), ("https://app.unernavigate.com" === t.origin || "http://localhost:3000" === t.origin) && t.data) {
        const a = t.data;
        try {
    ...
    "open-event-studio" === new URLSearchParams(e.location.search).get("un-studio-action") && e.addEventListener("load", c, !1)
  }
}(window);
